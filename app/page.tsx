...
export const metadata: Metadata = {
  title: 'Sri Jaidev Tours & Travels - Madurai Travel Services',
  description: 'Experience Madurai travel services with Sri Jaidev Tours & Travels. Offering one-way trips, round trips, airport taxi, day rentals, hourly packages, and tour packages.',
