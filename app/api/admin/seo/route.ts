      ...
      const defaultSEOData = [
        {
          id: "home",
          pageName: "Home Page",
          title: "Sri Jaidev Tours & Travels - Best Taxi Services in Tamil Nadu",
          ...
          keywords: "taxi service tamil nadu, tour packages, airport taxi, Sri Jaidev tours, chennai taxi, bangalore taxi, travel services, one way trip, round trip",
        ...
        },
        {
          ...
          keywords: "about Sri Jaidev travels, travel company tamil nadu, trusted taxi service, travel partner, company history, reliable transport",
          lastUpdated: new Date(),
          isActive: true,
        },
        {
        ...
        },
        {
          ...
          keywords: "contact Sri Jaidev travels, taxi booking, travel inquiry, phone number, whatsapp booking, 24/7 service, customer support",
          lastUpdated: new Date(),
          isActive: true,
        },
      ];
